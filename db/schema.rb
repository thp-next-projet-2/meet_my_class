...
ActiveRecord::Schema.define(version: 2019_05_16_222804) do
  ...
  create_table "participations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["klass_id"], name: "index_participations_on_klass_id"
  ...
  create_table "progressions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["klass_id"], name: "index_progressions_on_klass_id"
  ...
  create_table "questionables", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_id"], name: "index_questionables_on_question_id"
  end
  ...
  create_table "steps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["klasse_id"], name: "index_steps_on_klasse_id"
  end
  ...
  add_foreign_key "participations", "klasses"
  add_foreign_key "participations", "students"
  add_foreign_key "progressions", "klasses"
  add_foreign_key "progressions", "steps"
  add_foreign_key "progressions", "students"
  add_foreign_key "questionables", "questions"
  add_foreign_key "questions", "students"
  add_foreign_key "steps", "klasses", column: "klasse_id"
